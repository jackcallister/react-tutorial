...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener('DOMContentLoaded', function () {
	  return _reactRouter2['default'].run(_routes2['default'], _reactRouter2['default'].HistoryLocation, function (Handler) {
	    return _react2['default'].render(_react2['default'].createElement(Handler, { flux: flux }), document.getElementById('app'));
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsApp = __webpack_require__(287);

	var _componentsApp2 = _interopRequireDefault(_componentsApp);

	var _containersBooksContainer = __webpack_require__(286);

	var _containersBooksContainer2 = _interopRequireDefault(_containersBooksContainer);

	'use strict';

	var Routes = _react2['default'].createElement(
	  _reactRouter.Route,
	  { name: 'root', path: '/', handler: _componentsApp2['default'] },
	  _react2['default'].createElement(_reactRouter.Route, { name: 'books', path: 'books', handler: _containersBooksContainer2['default'] }),
	  _react2['default'].createElement(_reactRouter.DefaultRoute, { handler: _containersBooksContainer2['default'] })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flummox = __webpack_require__(10);

	var _flummox2 = _interopRequireDefault(_flummox);

	var _actionsBooksActions = __webpack_require__(12);

	var _actionsBooksActions2 = _interopRequireDefault(_actionsBooksActions);

	var _storesBooksStore = __webpack_require__(14);

	var _storesBooksStore2 = _interopRequireDefault(_storesBooksStore);
	...
	var Flux = (function (_Flummox) {
	  function Flux() {
	    ...
	    this.createActions('books', _actionsBooksActions2['default']);
	    this.createStore('books', _storesBooksStore2['default'], this);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Dispatcher = __webpack_require__(72);

	var _EventEmitter2 = __webpack_require__(74);
	...
	var _uniqueId = __webpack_require__(75);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _webUtilsBooksWebUtils = __webpack_require__(45);

	var _webUtilsBooksWebUtils2 = _interopRequireDefault(_webUtilsBooksWebUtils);

	var BooksActions = (function (_Actions) {
	  function BooksActions() {
	    _classCallCheck(this, BooksActions);
	  ...
	  _inherits(BooksActions, _Actions);

	  _createClass(BooksActions, [{
	    key: 'loadBooks',
	    value: function loadBooks() {
	      var response;
	      return _regeneratorRuntime.async(function loadBooks$(context$2$0) {
	        while (1) switch (context$2$0.prev = context$2$0.next) {
	          case 0:
	            context$2$0.next = 2;
	            return _webUtilsBooksWebUtils2['default'].fetch();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BooksStore = (function (_Store) {
	  function BooksStore(flux) {
	    _classCallCheck(this, BooksStore);

	    _get(Object.getPrototypeOf(BooksStore.prototype), 'constructor', this).call(this);

	    var booksActionConstants = flux.getConstants('books');
	    ...
	    this.registerAsync(booksActionConstants.loadBooks, this.handleLoadBooksBegin, this.handleLoadBooksSuccess, this.handleLoadBooksFailure);
	  }

	  _inherits(BooksStore, _Store);

	  _createClass(BooksStore, [{
	    key: 'handleLoadBooksBegin',
	    value: function handleLoadBooksBegin() {}
	  }, {
	    key: 'handleLoadBooksSuccess',
	    value: function handleLoadBooksSuccess(books) {
	      this.setState({
	        books: books,
	        loading: false
	      });
	    ...
	    key: 'handleLoadBooksFailure',
	    value: function handleLoadBooksFailure() {}
	  }]);

	  return BooksStore;
	})(_flummox.Store);

	exports['default'] = BooksStore;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _instanceMethods$staticProperties = __webpack_require__(50);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Promise = __webpack_require__(90)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _React$PropTypes = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Symbol = __webpack_require__(159)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = module.exports = __webpack_require__(223)({
	  g: global,
	  core: core,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(68);
	var getTextContentAccessor = __webpack_require__(234);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(220);
	__webpack_require__(221);
	module.exports = __webpack_require__(249)('iterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $   = __webpack_require__(162)
	  , cof = __webpack_require__(252)
	  , tmp = {};
	tmp[__webpack_require__(249)('toStringTag')] = 'z';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var set   = __webpack_require__(162).set
	  ...
	  , ITER  = __webpack_require__(254).safe('iter')
	  , $iter = __webpack_require__(251)
	  , step  = $iter.step;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $           = __webpack_require__(162)
	  , Iterators   = __webpack_require__(251).Iterators
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(162)
	  ...
	  , cof      = __webpack_require__(252)
	  , $def     = __webpack_require__(224)
	  , assert   = __webpack_require__(257)
	  , forOf    = __webpack_require__(258)
	  , setProto = __webpack_require__(259).set
	  , species  = __webpack_require__(260)
	  , SPECIES  = __webpack_require__(249)('species')
	  , RECORD   = __webpack_require__(254).safe('record')
	  , PROMISE  = 'Promise'
	  , global   = $.g
	  , process  = global.process
	  , asap     = process && process.nextTick || __webpack_require__(261).set
	  , P        = global[PROMISE]
	  , isFunction     = $.isFunction
	  , isObject       = $.isObject
	...
	$def($def.S + $def.F * !(useNative && __webpack_require__(262)(function(iter){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(162).core.Symbol;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(68);
	var emptyFunction = __webpack_require__(143);
	var joinClasses = __webpack_require__(268);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(name){
	  return store[name] || (store[name] =
	    global.Symbol && global.Symbol[name] || __webpack_require__(254).safe('Symbol.' + name));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(162)
	  , setUnscope = __webpack_require__(275)
	  , ITER       = __webpack_require__(254).safe('iter')
	  , $iter      = __webpack_require__(251)
	  , step       = $iter.step
	...
	__webpack_require__(255)(Array, 'Array', function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $                 = __webpack_require__(162)
	  , cof               = __webpack_require__(252)
	  , assertObject      = __webpack_require__(257).obj
	  , SYMBOL_ITERATOR   = __webpack_require__(249)('iterator')
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assertFunction = __webpack_require__(257).fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ctx  = __webpack_require__(256)
	  , get  = __webpack_require__(251).get
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SYMBOL_ITERATOR = __webpack_require__(249)('iterator')
	  , SAFE_CLOSING    = false;
	try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(162)
	  , setTag   = __webpack_require__(252).set
	...
	$.each.call((
	    ...
	    var sym = __webpack_require__(249)(it);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $           = __webpack_require__(162)
	  , UNSCOPABLES = __webpack_require__(249)('unscopables');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assertObject = __webpack_require__(257).obj;
	  ...
	  _createClass(Books, [{
	    ...
	    value: function renderBooks() {
	      return this.props.books.map(function (book) {
	        return _react2['default'].createElement(_book2['default'], { key: book.id, title: book.title });
	      });
	    }
	  }, {
	    key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsBooks = __webpack_require__(284);

	var _componentsBooks2 = _interopRequireDefault(_componentsBooks);
	  ...
	  _createClass(BooksContainer, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        { connectToStores: ['books'] },
	        _react2['default'].createElement(_componentsBooks2['default'], null)
	      );
	    }
	  }]);
